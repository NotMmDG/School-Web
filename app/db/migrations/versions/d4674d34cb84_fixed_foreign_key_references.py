...
Revision ID: d4674d34cb84
Revises: 
Create Date: 2024-07-27 15:47:00.150475
...
def upgrade() -> None:
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'book'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'college'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'educational_employee'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'room'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'dept'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'college_dept'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'course'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'employee'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'professor'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'student'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'borrow'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'section'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'takes'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'delete'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'grade'):
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'student_section'):
